...
function scoreBreakdown(course, preference, tags, context = {}) {
  ...
  const api = { RULE_VERSION, DEMO_PLACES, pointForStop, matches, score, scoreBreakdown, tasteSignals, tasteMatch, rank, sort, newId, courseCentroid, haversineKm, courseDistanceFromUser, calcGeoScore, calcDurationScore, calcTimeScore};  if (typeof module !== "undefined" && module.exports) module.exports = api;
